...
#stop of only a certain unit (1, 2, 3) if and only if the corresponding single unit number is specified (e.g. stop.py 1)  
...
#internal commands needed for stop procedure:
